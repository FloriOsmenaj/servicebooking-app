    ...
    <div className="container flex min-h-screen items-center justify-center px-4 py-8 md:px-6">
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-bold">Create a Client Account</CardTitle>
          <CardDescription>Enter your information to create a client account</CardDescription>
        </CardHeader>
        ...
        <CardFooter className="flex flex-col space-y-4">
          <div className="text-sm text-muted-foreground text-center">
            ...
            <Link href="/client/login" className="text-booksy-600 hover:underline inline-flex items-center gap-1">
              Log in <ArrowRight className="h-3 w-3" />
            </Link>
          </div>
          <div className="text-sm text-muted-foreground text-center">
            <Link href="/business/signup" className="text-salon-600 hover:underline">
              Business Signup
            </Link>
          </div>
        </CardFooter>
